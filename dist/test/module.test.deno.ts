import { getImageData, imageDataToGrayBuffer } from './utils.deno.ts';
import { ImageScanner } from '../ImageScanner.deno.ts';
import { scanImageData, scanGrayBuffer, getDefaultScanner } from '../module.deno.ts';
